...
if args.save_session:
    ...
    ddir = "Sessions/Session {}".format(str(datetime.datetime.now().date()))
    os.mkdir(ddir)
...
class FrontEnd(object):
    ...
    def run(self):
        ...
        def videoRecorder():
            ...
            ddir = "Video/{}".format(str(datetime.datetime.now().date()) )
            os.mkdir(ddir)
            video = cv2.VideoWriter('{}/{}.avi'.format(ddir,str(uuid.uuid4())), cv2.VideoWriter_fourcc(*'XVID'), 30, (width, height))
        ...
        while not should_stop:
            ...
            if args.save_session:
                ...
                if not os.path.isdir(ddir):
                    os.mkdir(ddir)
                cv2.imwrite("{}/fathom{}.jpg".format(ddir,imgCount),frameRet)
            ...
            for i in range(joystick_count):
                ...
                for event in pygame.event.get(): # User did something.
                    ...
                    if(event.type in joyCommand): 
                        ...
                        for i in range(buttons):
                            ...
                            convertButton=(float)("{:>2} ".format(button))
                            if(convertButton>0):
                ...
                if(OVERRIDE):
                    ...
                    for i in range(axes):
                        ...
                        if(convertAxis >= -1 and convertAxis <= 1):
                            if(i==0):
                                if(convertAxis==0):
                                    self.left_right_velocity = 0
                                elif(convertAxis>0):
